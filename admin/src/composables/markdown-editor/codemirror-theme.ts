...
const highlightStyle = HighlightStyle.define([
  ...
  { tag: [t.name, t.deleted, t.character, t.macroName], color: 'var(--cm-syntax-variable, #1f2328)' },
  ...
  { tag: [t.number, t.changed, t.annotation, t.constant(t.name)], color: 'var(--cm-syntax-number, #f59e0b)' },
  { tag: [t.function(t.variableName), t.function(t.name)], color: 'var(--cm-syntax-function, #0ea5e9)' },
