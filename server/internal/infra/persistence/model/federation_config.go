...
// FederationConfigItem stores federation settings in key-value form.
type FederationConfigItem struct {
...
func (FederationConfigItem) TableName() string { return "federation_config" }
